...
<div class="UT-page phase2_theme2" id="ut-page-content" role="main">
  ...
  <div class="container container-top">
    <?php if ($page['content_top_three_pillars']): ?>
      <div class="row">
        <?php if ($page['content_top_three_pillars']): ?>
          <div class="column small-12 medium-12">
            <?php print render($page['content_top_three_pillars']); ?>
          </div>
        <?php endif; ?>
      </div>
    <?php endif; ?>
  ...
  <?php if (isset($locked_fields['field_utexas_quick_links'])): ?>
    <div class="field_utexas_featured_links">
      <?php print (render($locked_fields['field_utexas_quick_links'])); ?>
    </div>
  <?php endif; ?>
  ...
  <?php if ($page['content_bottom'] or $page['sidebar_second']): ?>
    <div class="accented-container-wrapper">
      <div class="container container-bottom <?php if (isset($background_accent)) : echo "accent"; endif; ?>">
        <div class="row">
          <div class="column small-12 large-centered medium-12 large-10">
