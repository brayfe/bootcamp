 ...
 * @ingroup themeable.
 */
// echo stristr( $content, "field_location");

//Validates if there are no location fields
$field_location_exists = FALSE;
$field_location_array = array("field_location_1","field_location_2","field_location_city","field_location_state","field_location_zip");
...
$field_address_array = array("field_address_1","field_address_2","field_address_city","field_address_state","field_address_zip");
